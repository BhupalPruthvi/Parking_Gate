...
//Interrupt_Receiver_B
  //attachInterrupt(digitalPinToInterrupt(interrupt_pin_2), condition_0, RISING);
//Interrupt_Proximity_sensor
  //attachInterrupt(digitalPinToInterrupt(interrupt_pin_3), condition_0, RISING);
